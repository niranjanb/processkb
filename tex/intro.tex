...
However, reasoning with shallow text-derived representations is extremely difficult even when using state-of-the-art probabilistic methods~\cite{khot2015:emlnlp}. 
Creating effective semantic representations of knowledge is critical.
